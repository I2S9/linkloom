          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center space-x-4 mb-12">
                ...
                <span className={`text-lg font-medium transition-colors ${isAnnual ? 'text-black' : 'text-gray-600'}`}>Annual <span className="text-sm text-green-600 font-semibold">Save 20%</span></span>
              </div>
            </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                ...
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center">
                    ...
                    Limited history (3 searches)
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    CSV export limited to 50 rows
                  </li>
                </ul>
              ...
              <div className="bg-black rounded-2xl p-8 shadow-lg transform scale-105">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    ...
                    <span className="text-white">300 searches per month</span>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-white">200 results per search</span>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  ...
                  <li className="flex items-center">
                    ...
                    <span className="text-white">Unlimited CSV & Google Sheets export</span>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-white">Zapier / n8n / Make integrations</span>
                  </li>
                </ul>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                ...
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center">
                    ...
                    Automatic CRM exports (HubSpot, Salesforce...)
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
